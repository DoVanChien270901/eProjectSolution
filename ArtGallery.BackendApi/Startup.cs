...
namespace ArtGallery.BackendApi
{
    public class Startup
    {
        ...
        {
            //Declare DI
            services.AddDbContext<ArtGalleryDbContext>(op => op.UseSqlServer(Configuration.GetConnectionString(ArtGallery.Data.Constants.SystemContants.MainConnectionConString)));
